...
| [`geodesic-curvature.html`](geodesic-curvature.html) | GR | Geodesic curvature around a spherical Compton-zone boundary. 3D spatial mode shows intrinsic Schwarzschild curvature of a Cartesian grid; 2D+T mode shows worldlines tilting toward the mass. |
