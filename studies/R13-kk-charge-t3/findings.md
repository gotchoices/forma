...
### F18. The R8-multi-winding model breaks WvM's charge mechanism
...
For the R8-multi-winding (68, 137) electron:
...
### F21. The R8-multi-winding charge problem
...
| Gain from R8-multi-winding | Loss from R8-multi-winding |
|-------------------------|-------------------------|
...
The central result is Track 3's finding that the R8-multi-winding
...
Coulomb energy, or go R8-multi-winding with correct Coulomb energy
...
4. The R8-multi-winding model (p = 68) does not produce charge
