...
### R13 kills R8-multi-winding charge

R13 Track 3 showed that R8-multi-winding (p = 68) *breaks* the
...
With R8-multi-winding killed by R13, the surviving model is:
...
- **R8** — provides the R8-multi-winding model that this study
  argues was a detour.  R8's spin and g-factor results (Tracks
  2-3) carry over to the (1,2) model unchanged.
- **R13** — killed R8-multi-winding charge, reviving (1,2) at
  Compton scale.
...
- R7 findings: [`R7-torus-capacitance/findings.md`](../R7-torus-capacitance/findings.md)
- R7 README (forward calculation): [`R7-torus-capacitance/README.md`](../R7-torus-capacitance/README.md)
- R8 findings: [`R8-multi-winding/findings.md`](../R8-multi-winding/findings.md)
- R13 Track 3: [`R13-kk-charge-t3/findings.md`](../R13-kk-charge-t3/findings.md) (F18–F23)
