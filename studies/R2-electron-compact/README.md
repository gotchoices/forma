...
- S2 (charge geometry): [`S2-toroid-geometry/findings.md`](../S2-toroid-geometry/findings.md)
- S3 (knot classification): [`S3-knot-zoo/findings.md`](../S3-knot-zoo/findings.md)
- R1 (KK comparison): [`R1-kk-charge/findings.md`](../R1-kk-charge/findings.md)
