...
**Study concluded.** The premise (a 9% charge deficit requiring
structural correction) was found to be an artifact of geometric
approximations. See `findings.md` conclusion and `../S2-toroid-geometry/`
for the follow-on investigation.
...
## Not Pursued (study blocked)

- [ ] QED expansion parameters (α/π, α/(2π)) with rational coefficients
- [ ] Mixed-scale hybrid decomposition

These remain potentially interesting if the charge deficit target can
be independently sharpened. See `findings.md` "Open Avenues."
