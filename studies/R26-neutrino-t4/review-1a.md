...
the S3-knot-zoo script (01_knot_survey.py, lines 50–63) and the
S3-knot-zoo findings (F1, line 30: "L_z = ℏ/q").

**The S3-knot-zoo explicitly classifies (3,2) and (5,2) as spin-½:**
...
1. The spin formula L = ℏ/q was derived in the a ≪ R limit and
   flagged as "tentative" in the S3-knot-zoo (S3 F1, line 39).  At
...
Until then, the S3-knot-zoo's classification — ALL q = 2 modes are
