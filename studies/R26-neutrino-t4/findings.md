...
The S3-knot-zoo's Frenet frame result is correct for these modes.
...
The S3-knot-zoo's Frenet frame approach (S3) gave correct binary
...
[`../R19-shear-charge/findings.md`](../R19-shear-charge/findings.md).
