...
The S3-knot-zoo (S3) computed charge using the Frenet frame for polarization
...
def main():
  ...
  4. The S3-knot-zoo's Frenet frame result (only (1,2) charged) is
...
""")
  ...
  CONCLUSION: The charge transport law does not change the S3-knot-zoo's
