...
R8-multi-winding path — the local structure is the same.
...
3. **Anomalous g-factor.**  The leading g = 2 is
   ...
   to the R8-multi-winding case is a future investigation.
...
1. **What selects q (and hence the shear)?**  Every odd q
   ...
   **R11 (COMPLETE — see [`R11-prime-resonance/findings.md`](../R11-prime-resonance/findings.md)):**
...
2. **Anomalous magnetic moment.**  Track 3 established the
   ...
   fraction for the R8-multi-winding geometry would test whether
