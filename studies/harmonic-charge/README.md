...
- R12 Track 1: flat-T² spectrum, spectral gap
  [`self-consistent-fields/findings.md`](../self-consistent-fields/findings.md)
- R13 Track 3: monopole integral, Fourier analysis
  [`kk-charge-t3/findings.md`](../kk-charge-t3/findings.md) (F18–F23)
- R7 Possibility A: near-field/far-field split
  [`torus-capacitance/findings.md`](../torus-capacitance/findings.md) (F4)
