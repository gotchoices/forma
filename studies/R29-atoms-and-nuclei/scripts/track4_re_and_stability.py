...
3. Confirm that atomic binding is below Ma resolution
"""
...
def nuclear_mode_energy(A, Z, Gti, L, target_mass=None, n2_range=40):
    """
    Compute the Ma mode energy for nucleus (A, Z) using the
...
def main():
    ...
    print("  If Ma determines stability, the minimum should be Z = 6.\n")
    ...
    print("  This means: Ma determines the total mass of a nucleus")
    ...
    print("  inter-particle effects, Ma handles the internal energy.")

    # ── Section 4: What does determine stability? ─────────────────────
    section(4, "Physical origin of stability preference")

    print("  In the Ma model, n₁ = N (neutron count) is the electron-")
    ...
    print("  why all Z compositions have nearly the same Ma energy.")
    print()
    print("  CONCLUSION: Ma determines WHAT nuclei exist (mass from A).")
    ...
    print("  Ma mode energy spacing near the proton mass:\n")
    ...
    print("  to Ma modes (MeV scale).  Nuclei are Ma modes; atoms are")
    ...
    print()
    print("  2. STABILITY: Ma determines nuclear mass from A alone.")
    print("     The Z composition is energetically degenerate in Ma.")
    print("     Which Z is stable must come from R³ (Coulomb, etc.).")
    print()
    print("  3. ATOMS ≠ Ma MODES: Atomic binding is 10⁵ – 10⁶×")
    print("     below Ma energy resolution.  Atoms are nuclei (Ma)")
