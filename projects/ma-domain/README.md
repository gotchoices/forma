...
<!--EC We shouldn't be dogmatic about 6 dimensions in this project.  It is about an N-dimensional domain that hosts the 3 fundamental particles (proton, electron, neutrino).  (It's OK to have the assumption that we're _attempting_ to fit into 6 dimensions.) -->
...
<!--EC I don't think model-F is a hard given in this study.  We'll derive shears from scratch as needed.  Earlier models are of interest as a guide but not as a hard requirement. -->
...
4. **Phase 3 (neutrino sector)** — find the best fit to match known neutrino behavior.  May need to extend to a 7th dimension if necessary.
...
- The lowest modes that satisfy closure conditions (see metri-charge) are the observable particles.
