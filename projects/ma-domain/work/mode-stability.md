...
1. **The origin of baryon-number conservation.** §3 flags that proton stability needs a conserved quantity beyond energy and charge that the framework does not derive. Is there a topological baryon-number analog — a winding count of the quark clover, say — or is proton stability genuinely contingent? Until this is settled, electron stability rests on firmer ground (energy + topological charge, both fundamental) than proton stability.
