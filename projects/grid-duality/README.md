...
3. **Substrate is shared; models differ.** Lattice geometry, edge polarity, common-direction orientation, and master clock concept are foundational. State structure, update rules, and clock-phase count are model-dependent.
