...
(A note on σ_uw shear: σ_uw is a *symmetric* off-diagonal entry (g_uw = g_wu) and does not break the wrap-order's (u, w) ↔ (w, u) swap symmetry. What it breaks is a *chirality* symmetry on the (m, n) labels (R_u and R_w in the notation of [Chapter 5](05-metric-self-consistency.md)) — biasing the internal amplitude balance of the natural particle. σ_uw is a structurally separate asymmetry-introducing mechanism, examined in [Chapter 6 §6](06-handedness-and-pairs.md) and [Chapter 8 §3](08-shear-and-fractional-charge.md).)
