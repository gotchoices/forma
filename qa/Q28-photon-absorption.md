...
**Related:** [Q16](INBOX.md#q16), [Q27](Q27-foundational-axioms.md)

**Question:** In standard QM, an orbiting electron absorbs a photon and jumps to a
higher energy level. In this model the electron IS a photon on the material sheet. What does "absorb
another photon" mean, and does it predict discrete spectra?
...
a photon on the material sheet.  What does "absorb another photon" mean?
Possible pictures:
- The second photon enters the compact space and adds energy to
  the existing mode — a higher harmonic or larger amplitude on
  the same material sheet.  The material space now holds more energy, giving
