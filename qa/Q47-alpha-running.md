...
3. Check if material dims modify the β coefficient consistently
   with experiment.
4. See if GUT convergence at 1/24 has a geometric interpretation.

## Connection to Q34

If α runs because higher-energy probes penetrate deeper into
the material space (seeing more of the bare charge), this is
the same physics as Q34 Path 3 (membrane permeability).  The
"leakage fraction" IS α, and it runs with probe energy.
