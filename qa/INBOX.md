...
Q47. **Geometric interpretation of the running of α.** → [Q47-alpha-running.md](Q47-alpha-running.md) *(open)*
...
Q51. **Non-torus embeddings and mode-coupling route to α.** → [Q51-non-torus-embeddings.md](Q51-non-torus-embeddings.md) *(open — → R17)*

Q52. **Dimensional assignment constrains the aspect ratio.** → [Q52-dimensional-assignment.md](Q52-dimensional-assignment.md) *(open — r = 1/2 checked)*

Q53. **Anomalous magnetic moment (g − 2).** → [Q53-anomalous-magnetic-moment.md](Q53-anomalous-magnetic-moment.md) *(open)*

Q57. **Does T³ break the φ-symmetry that protects zero charge?** → [Q57-t3-phi-symmetry.md](Q57-t3-phi-symmetry.md) *(open — promising)*
...
Q56. **Natural-units analysis of the photon-knot model.** → [Q56-natural-units-analysis.md](Q56-natural-units-analysis.md) *(open)*

Q58. **Shear breaks φ-symmetry and produces charge.** → [Q58-shear-charge-mechanism.md](Q58-shear-charge-mechanism.md) *(→ R19)*
...
Q34. **The charge mechanism problem.** → [Q34-charge-mechanism.md](Q34-charge-mechanism.md) *(open — 8 candidate paths)*
